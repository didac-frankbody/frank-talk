...
import { FrankLoadingMark } from "@/shared/ui/frank-logo/FrankLoadingMark";
...
// Cold boot gate: the theme-adaptive grainient background with the frank talk
// mark breathing over it. "Setting up your community" stays as an sr-only
// caption rather than on-screen text.
