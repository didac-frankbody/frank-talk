          ...
          {!identity ? (
            <div className="rounded-xl border border-amber-500/40 bg-amber-500/5 p-5">
              <h3 className="font-medium">
                Link this account to your frank talk identity
              </h3>
              <p className="mt-2 text-sm text-muted-foreground">
                This Builderlab account isn&apos;t linked to a frank talk
                identity yet. Connect this device&apos;s key to create and own
                communities under it — frank talk signs a one-time challenge
            ...
            <div className="rounded-xl border border-amber-500/50 bg-amber-500/5 p-5">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h3 className="font-medium">
                    This account is connected to a different frank talk identity
                  </h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Your Builderlab account owns communities under another frank
                    talk key, so connecting them here would join a relay this
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-border/70 p-4">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <CheckCircle2 className="h-4 w-4 text-emerald-500" /> frank talk
                identity connected
                {identity.npub ? (
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Your Builderlab account will no longer be connected to this frank
            talk key. You can reconnect any key later, but community actions
            stay unavailable until you do.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            member. The recipient needs a connected frank talk identity first,
